...
void CleanConsole()
{
	...
	SE COMENTÓ ESTA FUNCIÓN Y TODAS SUS INCIDENCIAS EN EL PROGRAMA, DEBIDO A QUE SU USO GENERA UN WARNING ÚNICAMENTE EN ECLIPSE, PERO QUE ES CONTABILIZADO EN LA CORRECCIÓN DEL TRABAJO PRÁCTICO
